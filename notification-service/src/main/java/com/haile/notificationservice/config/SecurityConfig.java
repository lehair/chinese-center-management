package com.haile.notificationservice.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/v1/notifications/admin/**", "/api/v1/posts/admin/**").hasRole("ADMIN")
                        .anyRequest().permitAll() // Allow other interactions to pass (if any) or specify later
                )
